    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/ATTACK.WAD -warp 01M";
        ...
        private string ConstruirParametros()
        {
            ...
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -respawn -warp 01M ";
            }
            
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/ATTACK.WAD -warp 01M -connect";
            }
        ...
        private void EjecutarExe1(string parametros)
        {
            try
            {
                ...
                procesoInfo.FileName = "crispy-doom.exe";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/BLACKTWR.WAD -warp 25M";
                ...
                {
                    MessageBox.Show($"Error starting crispy-doom: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        ...
        private string ConstruirParametros2()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -fast -warp 025M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -nomonsters -warp 025M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -respawn -warp 025M";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -warp 25M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -warp 25M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLACKTWR.WAD -warp 25M -connect ";
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/BLOODSEA.WAD -warp 07M";
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
        ...
        private string ConstruirParametros3()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/BLOODSEA.WAD -warp 07M -connect ";
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/CANYON.WAD -warp 01M";
                string serverName2 = textBox23.Text;
                string argumentos4 = $" {serverName2}";
                string ipServidor4 = textBox25.Text;
                string argumentos5 = $" {ipServidor4}";
        ...
        private string ConstruirParametros4()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CANYON.WAD -warp 01M -connect ";
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/CATWALK.WAD -warp 01M";
        ...
        private string ConstruirParametros5()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/CATWALK.WAD -warp 01M -connect ";
            }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/COMBINE.WAD -warp 01M";
        ...
        private string ConstruirParametros6()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/COMBINE.WAD -warp 01M -connect ";
            }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/FISTULA.WAD -warp 01M";
        ...
        private string ConstruirParametros7()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/FISTULA.WAD -warp 01M -connect ";
            }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/GARRISON.WAD -warp 01M";
        ...
        private string ConstruirParametros8()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GARRISON.WAD -warp 01M -connect ";
            }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/GERYON.WAD -warp 08M";
        ...
        private string ConstruirParametros9()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -fast -warp 08M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -nomonsters -warp 08M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -respawn -warp 08M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -warp 08M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -warp 08M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/GERYON.WAD -warp 08M -connect ";
            }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/MANOR.WAD -warp 01M";
        ...
        private string ConstruirParametros10()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MANOR.WAD -warp 01M -connect ";
            }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/MEPHISTO.WAD -warp 07M";
        ...
        private string ConstruirParametros11()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MEPHISTO.WAD -warp 07M -connect ";
            }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/MINOS.WAD -warp 05M";
        ...
        private string ConstruirParametros12()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -fast -warp 05M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -nomonsters -warp 05M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -respawn -warp 05M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -warp 05M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -warp 05M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/MINOS.WAD -warp 05M -connect ";
            }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/NESSUS.WAD -warp 07M";
        ...
        private string ConstruirParametros13()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -fast -warp 07M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -nomonsters -warp 07M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -respawn -warp 07M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -warp 07M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -warp 07M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/NESSUS.WAD -warp 07M -connect ";
            }
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/PARADOX.WAD -warp 01M";
        ...
        private string ConstruirParametros14()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/PARADOX.WAD -warp 01M -connect ";
            }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/SUBSPACE.WAD -warp 01M";
        ...
        private string ConstruirParametros15()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBSPACE.WAD -warp 01M -connect ";
            }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/SUBTERRA.WAD -warp 01M";
        ...
        private string ConstruirParametros16()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/SUBTERRA.WAD -warp 01M -connect ";
            }
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/TEETH.WAD -warp 31M";
        ...
        private string ConstruirParametros17()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -fast -warp 31M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -nomonsters -warp 31M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -respawn -warp 31M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 31M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 31M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 31M -connect ";
            }
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/TTRAP.WAD -warp 01M";
        ...
        private string ConstruirParametros18()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -fast -warp 01M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -nomonsters -warp 01M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -respawn -warp 01M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -warp 01M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -warp 01M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TTRAP.WAD -warp 01M -connect ";
            }
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/VESPERAS.WAD -warp 09M";
        ...
        private string ConstruirParametros19()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -fast -warp 09M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -nomonsters -warp 09M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -respawn -warp 09M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -warp 09M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -warp 09M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VESPERAS.WAD -warp 09M -connect ";
            }
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/VIRGIL.WAD -warp 03M";
        ...
        private string ConstruirParametros20()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -fast -warp 03M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -nomonsters -warp 03M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -respawn -warp 03M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -warp 03M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -warp 03M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/VIRGIL.WAD -warp 03M -connect ";
            }
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked)
            {
                ...
                string master = "crispy-doom -iwad DOOM2.WAD -merge master-wads/TEETH.WAD -warp 32M";
        ...
        private string ConstruirParametros21()
        {
            ...
            if (checkBox6.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -fast -warp 32M ";
            }
            if (checkBox7.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -nomonsters -warp 32M ";
            }
            if (checkBox8.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -respawn -warp 32M ";
            }
            if (checkBox43.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 32M -autojoin";
            }
            if (checkBox44.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 32M -privateserver";
            }
            if (checkBox45.Checked)
            {
                parametros += "crispy-doom -merge master-wads/TEETH.WAD -warp 32M -connect ";
            }
        ...
        private string ConstruirParametros22()
        {
            ...
            {
                parametros2 += "crispy-doom -respawn ";
            }
            if (checkBox15.Checked)
            {
                parametros2 += "crispy-doom -fast ";
            }
            if (checkBox16.Checked)
            {
                parametros2 += "crispy-doom -nomonsters ";
            }
           
            if (checkBox21.Checked)
            {
                parametros2 += "crispy-doom -autojoin ";
            }
            if (checkBox22.Checked)
            {
                parametros2 += "crispy-doom -privateserver ";
            }
            if (checkBox23.Checked)
            {
                parametros2 += "crispy-doom -connect ";
            }
        ...
        private void button23_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Error starting crispy-doom: The system cannot find the specified file.");
                }
            }
        }
        ...
        private string ConstruirParametros24()
           {
            ...
            {
                  parametros3 += "crispy-doom -respawn ";
            }
            if (checkBox34.Checked)
            {
                  parametros3 += "crispy-doom -fast ";
            }
            if (checkBox36.Checked)
            {
                  parametros3 += "crispy-doom -nomonsters ";
            }
           
            if (checkBox26.Checked)
            {
                  parametros3 += "crispy-doom -autojoin ";
            }
            if (checkBox27.Checked)
            {
                  parametros3 += "crispy-doom -privateserver ";
            }
            if (checkBox28.Checked)
            {
                 parametros3 += "crispy-doom -connect ";
            }
...
private string ConstruirParametros48()
{
    ...
    return parametros48.Trim();
        ...
        {
            // F11: Entrar a pantalla completa y quitar bordes
            ...
            // Esc: Salir de pantalla completa y restaurar bordes
            if (e.KeyCode == Keys.Escape)
            {
                this.FormBorderStyle = FormBorderStyle.Sizable; // O el borde que uses por defecto
